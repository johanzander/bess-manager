...
- **Huawei battery discharge power is no longer reported "Not configured"** — the single signed battery register now backs both the charge and discharge readings, as already done for grid power. ([#120](https://github.com/johanzander/bess-manager/issues/120))
