...
- **Growatt MIN inverter writes now wait until a plan change can actually take effect** — nudging a running window's end no longer rewrites it hours early, cutting the remaining write overhead close to the theoretical floor. ([#589](https://github.com/johanzander/bess-manager/issues/589))
