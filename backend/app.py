...
class BESSController:
    ...
    def refresh_power_polarity(self) -> None:
        """Sync the live ha_controller power-sign conventions from settings.
        ...
        apply to a shared signed grid-power or battery-power sensor. Call
        this after any settings mutation that can touch the inverter section.
        """
