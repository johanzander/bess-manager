...
same fixture yields 41 of 68 (60.3%), the DP having changed underneath it
since #393 (notably #512's finer state/action grid). The majority-open regime
it identified does still hold, which is all the sanity check below asserts.

The breadth is real and corpus-wide: the gate is open in 431 of 603
